...
import { ERROR_CODE, ErrorResponseInfo, isErrorResponse } from '../error-code.constant';
...
export class AllExceptionFilter implements ExceptionFilter {
    ...
    // 기본 에러 응답을 정의합니다.
    const errorResponse: ErrorResponseInfo<any> = ERROR_CODE.INTERNAL_SERVER_ERROR;
